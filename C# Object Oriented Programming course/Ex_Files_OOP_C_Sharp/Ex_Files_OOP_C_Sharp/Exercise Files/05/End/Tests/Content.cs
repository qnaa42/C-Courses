...
namespace Tests
{
    ...
    {
        internal Dictionary<User, List<Post>> PublishedPosts { get; set; } = new Dictionary<User, List<Post>>();
        ...
        {
            var feedPublished = from kvp in PublishedPosts
            ...
            return feedPublished
                    .SelectMany(lst => from post in lst select post)
