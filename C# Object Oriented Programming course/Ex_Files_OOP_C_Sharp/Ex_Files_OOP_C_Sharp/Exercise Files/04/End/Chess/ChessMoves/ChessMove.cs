...
namespace ChessMoves
{
    public class ChessMove
    {
        ...
        public ChessPieces CapturedPiece { get; set; } = ChessPieces.None;
        ...
        public static bool Try(string move, ref ChessMove result)
        {
            ...
            boardAfter[dest[0] - 65, dest[1] - 49] = boardAfter[start[0] - 65, start[1] - 49];
            boardAfter[start[0] - 65, start[1] - 49] = ChessPieces.None;
            ...
            var next = new ChessMove()
            {
                ...
                Before = boardBefore,
                After = boardAfter,
                CapturedPiece = boardBefore[dest[0] - 65, dest[1] - 49]
            };
